...
var App = React.createClass({
	...
	mouseUp(area) {
		this.setState({
			msg: `You moused up on ${area.shape} at coords ${JSON.stringify(area.coords)} !`
		});
	},
	mouseDown(area) {
		this.setState({
			msg: `You moused down on ${area.shape} at coords ${JSON.stringify(area.coords)} !`
		});
	},
	clicked(area) {
		this.setState({
		...
		return (
			<div className='grid'>
				...
				<div className='source'>
					...
					<pre>
						<code className='js' style={{ display: this.state.codeDetails ? 'block' : 'none' }}>
							{'enterArea(area) {\n' +
					...
					<pre>
						<code className='css' style={{ display: this.state.stylindDetails ? 'block' : 'none' }}>
							{'.container {\n' +
								'    position: relative;\n' +
								'}\n\n' +
								'.tooltip {\n' +
